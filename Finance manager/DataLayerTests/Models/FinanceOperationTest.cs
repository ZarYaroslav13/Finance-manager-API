...
public class FinanceOperationTest
{
    ...
    public void Equals_FinanceOperationAreEqual_True(FinanceOperation fo1, object fo2)
    {
    ...
    public void Equals_FinanceOperationAreEqual_False(FinanceOperation fo1, object fo2)
    {
